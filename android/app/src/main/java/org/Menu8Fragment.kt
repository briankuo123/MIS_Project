 ...
 * Use the [Menu8Fragment.newInstance] factory method to
...
class Menu8Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_menu8, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener { view ->
            ...
            controller.navigate(R.id.action_menu8Fragment_to_menu2Fragment)
        }
        button2 = requireView().findViewById(R.id.imageButton2)
        button2.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu8Fragment_to_homePageFragment)
        }
        button3 = requireView().findViewById(R.id.button12)
        button3.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu8Fragment_to_menuChooseFragment)
        }
        button4 = requireView().findViewById(R.id.button13)
        button4.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu8Fragment_to_menuChoose2Fragment)
        }
        button5 = requireView().findViewById(R.id.button14)
        button5.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu8Fragment_to_menuChoose3Fragment)
        }
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): Menu8Fragment {
            val fragment = Menu8Fragment()
            val args = Bundle()
