 ...
 * Use the [MenuChoose3Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MenuChoose3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_menu_choose3, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener { view ->
            ...
            controller.navigate(R.id.action_menuChoose3Fragment_to_menuFragment)
        }
        //回首頁
        button2 = requireView().findViewById(R.id.imageButton11)
        button2.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menuChoose3Fragment_to_homePageFragment)
        }
        //開始運動
        ...
        button3.setOnClickListener { view ->
            ...
            if ( ExeTimes >= 10 ) {
                ...
                val controller = findNavController(view)
                controller.navigate(R.id.action_menuChoose3Fragment_to_exersice3Fragment)
            }
        }
        //動作一教學
        ...
        button4.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menuChoose3Fragment_to_MovementPlankFragment)
        }
        //動作二教學
        button5 = requireView().findViewById(R.id.button13)
        button5.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menuChoose3Fragment_to_MovementSitUpFragment)
        }
        //動作三教學
        button6 = requireView().findViewById(R.id.button14)
        button6.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menuChoose3Fragment_to_MovementLegRaiseFragment)
        }
        //動作四教學
        button7 = requireView().findViewById(R.id.button15)
        button7.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menuChoose3Fragment_to_MovementBirdDogFragment)
        }
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): MenuChoose3Fragment {
            val fragment = MenuChoose3Fragment()
            val args = Bundle()
