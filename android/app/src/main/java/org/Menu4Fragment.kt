...
class Menu4Fragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener { view ->
            ...
            controller.navigate(R.id.action_menu4Fragment_to_menu2Fragment)
        }
        button2 = requireView().findViewById(R.id.imageButton2)
        button2.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu4Fragment_to_homePageFragment)
        }
        button3 = requireView().findViewById(R.id.button12)
        button3.setOnClickListener { view ->
            val controller = findNavController(view)
            controller.navigate(R.id.action_menu4Fragment_to_menuChooseFragment)
        }
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): Menu4Fragment {
